function [vec, grad, resid, residNorm_prev, maxChange] = RestrictedSD_M_smv(vec, grad, y, resid, A_smv, bin, bin_counters, residNorm_prev, num_bins, kbin, m, n)
...
resid_update = A_smv*grad_thresh;
