...
for j=1:length(alg_list)
  [km_cell{j} error_cell{j} junk] = make_delta_rho_plot_noise(alg_list{j},ensemble,n,succCriteria,nz,noise_level,vecDistr);
  [km_cell{j} time_cell{j} junk] = make_delta_rho_plot_noise(alg_list{j},ensemble,n,'time_for_alg',nz,noise_level,vecDistr);
