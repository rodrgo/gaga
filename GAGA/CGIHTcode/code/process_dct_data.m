function process_dct_data(alg_list, startdate, enddate)
% process_dct_data(alg_list, startdate, enddate)
...
% This function process the data for all algorithms in the list for the matrix ensemble 'dct'
% and for sparse binary vectors with no noise, i.e. problem class (DCT, B).
% For noise or for other vector distributions, use process_dct_data_noise.
...
if specific_dates
  filenames = get_data_file_names('dct',0,1,startdate,enddate);
else
  filenames = get_data_file_names('dct');
end
