function []=File_output_timings(foutput, k, m, n, vecDistribution, errors, timings, iter, conv_rate, checkSupport, seed, time_per_iteration, time_supp_set, algstr, alpha, supp_flag)
