function [vec, residNorm_prev, iter, time_sum, ksum, time_per_iteration, time_supp_set] = NIHT_M_timings_smv(y, A_smv, k, m, n, tol, maxiter, supp_flag)
% This function has the usage 
% [vec, residNorm_prev, iter, time_sum, ksum, time_per_iteration, time_supp_set] 
%       = NIHT_M_timings_smv(y, A_smv, k, m, n, tol, maxiter, supp_flag);
