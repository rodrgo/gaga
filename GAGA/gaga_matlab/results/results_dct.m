function [errors, timings, checkSupport, convRate] = results_dct(vec, vec_input, vecDistribution, residNorm_prev, iter, checkSupport, totaltime, time_sum, ksum, k, m, n, seed, timeTest, algstr)
% results function
...
month=c(2);
day=c(3);
fname=sprintf('matlab_data_dct%d%02d%02d.txt',year,month,day);
