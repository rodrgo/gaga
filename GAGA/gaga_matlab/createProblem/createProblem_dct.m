function [vec_input, y, dct_rows, seed] = createProblem_dct(k, m, n, vecDistribution, seed)
% [vec_input, y, dct_rows, seed] = createProblem_dct_noise(k, m, n, vecDistribution, seed)
