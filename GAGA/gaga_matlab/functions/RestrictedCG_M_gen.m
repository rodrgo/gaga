function [vec, grad, grad_previous, residNorm_prev, mu] = RestrictedCG_M_gen(vec, grad, grad_previous, y, A_gen, bin, residNorm_prev, kbin, m, n, mu)
