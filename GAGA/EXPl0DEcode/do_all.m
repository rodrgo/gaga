...
run('phase_transitions/data/er/query.m');
run('phase_transitions/data/parallel_l0/query.m');
run('phase_transitions/data/parallel_lddsr/query.m');
run('phase_transitions/data/serial_l0/query.m');
run('phase_transitions/data/smp/query.m');
