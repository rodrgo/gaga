function process_gen_data_noise(alg_list, noise_list, vecDistr_list, startdate, enddate)
% process_gen_data_noise(alg_list, noise_list, vecDistr_list, startdate, enddate)
...
for qq=1:length(noise_list)
  ...
  if specific_dates
    filenames = get_data_file_names('gen',noise_level,no_zero_string,startdate,enddate);
  else
    filenames = get_data_file_names('gen',noise_level,no_zero_string);
  end
