fnames=ls;
fname_start='matlab_timings_data_smv';
...
data_ready=1;
fname_save=sprintf('results_NIHT_smv_matlab_timing_supp_flag_%d.mat',supp_flag);
...
if (data_ready==0)
  ...
  fname=['matlab_timings_data_smv' date_string '.txt'];
  fid = fopen(fname);
  if fid~=-1
    display(date_string)
...
%{
thisalg=results_full{100,1}
thisvec=results_full{100,13}
thisalpha=results_full{100,41}
thissuppflag=results_full{100,43}
thismatens=results_full{100,47}
%}
