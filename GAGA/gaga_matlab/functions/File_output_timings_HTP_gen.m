function []=File_output_timings_HTP_gen(foutput, k, m, n, matrixEnsemble, vecDistribution, errors, timings, iter, conv_rate, checkSupport, seed, time_per_iteration, time_supp_set, cg_per_iteration, time_for_cg, algstr, alpha, supp_flag)


fprintf(foutput,'%s_M_gen output: ',algstr);
