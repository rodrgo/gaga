function [vec, grad, grad_previous, grad_prev_thresh, residNorm_prev, mu, maxChange] = UnrestrictedCG_M_dct(vec, grad, grad_previous, grad_prev_thresh, y, dct_rows, bin, residNorm_prev, kbin, m, n, mu, beta_to_zero_flag)
...
grad = AT_dct(resid_update, m, n, dct_rows);
