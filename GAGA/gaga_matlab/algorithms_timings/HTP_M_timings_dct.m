function [vec, residNorm_prev, iter, time_sum, ksum, time_per_iteration, time_supp_set, cg_per_iteration, time_for_cg] = HTP_M_timings_dct(y, dct_rows, k, m, n, tol, maxiter, supp_flag)
...
%       = HTP_M_timings_dct(y, dct_rows, k, tol, maxiter, supp_flag)
