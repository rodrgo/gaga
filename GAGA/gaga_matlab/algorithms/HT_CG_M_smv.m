function [vec, residNorm_prev, iter, time_sum, ksum] = HT_CG_M_smv(y, A_smv, k, m, n, tol, maxiter)
...
while ( (err>tolCG) && (iter < maxiter) && (residNorm_diff > tol2) ) 
    ...
    [vec, grad, grad_previous, residNorm_prev, mu] = RestrictedCG_M_smv(vec, grad, grad_previous, y, A_smv, bin, residNorm_prev, kbin, m, n, mu);
