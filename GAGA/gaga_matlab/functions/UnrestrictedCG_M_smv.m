function [vec, grad, grad_previous, grad_prev_thresh, residNorm_prev, mu, maxChange] = UnrestrictedCG_M_smv(vec, grad, grad_previous, grad_prev_thresh, y, A_smv, bin, residNorm_prev, kbin, m, n, mu, beta_to_zero_flag)
...
%     = RestrictedCG_M_smv(vec, grad, grad_previous, A_smv, bin, residNorm_prev, kbin)
