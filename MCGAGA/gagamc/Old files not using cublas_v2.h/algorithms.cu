...
//  cout << "iter = " << iter << "   err = " << err << endl;
  ...
  RestrictedSD_MC_S_entry(d_Mat, Grad_prev, Grad_prev_proj, d_Y, d_U, d_S, d_V, d_A, d_y, d_u, d_u_prev, d_v, residNorm_prev, m, n, r, p, mn, SVDmaxIter, SVDTol, SVDgen, threadsPerBlockp, numBlocksp, threadsPerBlockm, numBlocksm, threadsPerBlocknr, numBlocksnr, threadsPerBlockmn, numBlocksmn);
...
*/
  ...
  UnrestrictedCG_MC_S_entry(d_Mat, Grad, Grad_proj, Grad_prev, Grad_prev_proj, d_Y, d_U, d_S, d_V, d_A, d_y, d_y_work, d_u, d_u_prev, d_v, residNorm_prev, m, n, r, p, mn, SVDmaxIter, SVDTol, SVDgen, threadsPerBlockp, numBlocksp, threadsPerBlockm, numBlocksm, threadsPerBlocknr, numBlocksnr, threadsPerBlockmn, numBlocksmn);
