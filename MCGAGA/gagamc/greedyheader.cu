...
#include "cublas.h"
#include "cublas_v2.h"  //suic: added cublas_v2.h for more functionality like matrix transpose
//#include <math.h>


#include "kernels.cu"
#include "sensors.cu"
#include "functions_v2.cu" //suic: changed syntax to cublas_v2.h
#include "functions_suic_v2.cu"  //suic: functions written by Chenshuai Sui using cublas_v2.h
#include "results_v2.cu" //suic: changed syntax to cublas_v2.h; small indexing change in cublasIsamax
 
#include "createProblem_entry_v2.cu"  //suic: changed syntax to cublas_v2.h; small indexing change in kernel randSelectInts
#include "algorithms_v2.cu" //suic: changed syntax to cublas_v2.h;
#include "algorithms_suic_v2.cu" //suic: algorithms written by Chenshuai Sui using cublas_v2.h
