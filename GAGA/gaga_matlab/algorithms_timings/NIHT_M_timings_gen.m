function [vec, residNorm_prev, iter, time_sum, ksum, time_per_iteration, time_supp_set] = NIHT_M_timings_gen(y, A_gen, k, m, n, tol, maxiter, supp_flag)
% This function has the usage 
% [vec, residNorm_prev, iter, time_sum, ksum time_per_iteration, time_supp_set] 
%       = NIHT_M_timings_gen(y, A_gen, k, m, n, tol, maxiter, supp_flag)
