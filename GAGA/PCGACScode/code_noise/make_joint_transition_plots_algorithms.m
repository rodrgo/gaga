function make_joint_transition_plots_algorithms(ens,n,nonzeros,noise_level,vecDistribution,alg_list,no_zero_noise_str)
...
fname1=['noiseplots/transition_allALG_' ens];
if strcmp(ens,'smv')
