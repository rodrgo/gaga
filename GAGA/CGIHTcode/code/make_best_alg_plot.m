...
[km_cell{1} error_cell{1} junk] = make_delta_rho_plot(alg_list{1},ensemble,n,succCriteria,nz,noise_level,vecDistr);
[km_cell{2} error_cell{2} junk] = make_delta_rho_plot(alg_list{2},ensemble,n,succCriteria,nz,noise_level,vecDistr);

[km_cell{1} time_cell{1} junk] = make_delta_rho_plot(alg_list{1},ensemble,n,'time_for_alg',nz,noise_level,vecDistr);
[km_cell{2} time_cell{2} junk] = make_delta_rho_plot(alg_list{2},ensemble,n,'time_for_alg',nz,noise_level,vecDistr);
...
if length(alg_list)>2
 for jj=3:length(alg_list)
  [km_cell{jj} error_cell{jj} junk] = make_delta_rho_plot(alg_list{jj},ensemble,n,succCriteria,nz,noise_level,vecDistr);
  [km_cell{jj} time_cell{jj} junk] = make_delta_rho_plot(alg_list{jj},ensemble,n,'time_for_alg',nz,noise_level,vecDistr);
...
fname_out=['plots/algorithm_selection_' ensemble '_n_' num2str(n)  fig_suffix];
if strcmp('smv',ensemble)
  fname_out=['plots/algorithm_selection_' ensemble '_n_' num2str(n)  ...
...
fname_out=['plots/best_time_' ensemble '_n_' num2str(n)  fig_suffix];
if strcmp('smv',ensemble)
  fname_out=['plots/best_time_' ensemble '_n_' num2str(n)  ...
...
for i=1:length(alg_list)
  ...
  fname_out=['plots/' lower(alg_list{i}) '_ratio_' ensemble '_n_' num2str(n)  fig_suffix];
  if strcmp('smv',ensemble)
    fname_out=['plots/' lower(alg_list{i}) '_ratio_' ensemble '_n_' num2str(n)  ...
               '_nonzeros_' num2str(nonzeros) fig_suffix];
  end
  print(print_command,fname_out)
